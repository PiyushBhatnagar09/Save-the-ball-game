...
const storeName = "TempName";
const storeScore = "TempMaxScore";
...
(function () { //this function will run automatically when we open page or refresh the page
    ...
    alert("INSTRUCTIONS:-\n1. Press The Enter Key to start the Game\n2. Use 'A' or '<-' to move rod left and 'D' or '->' to move rod right\nGOOD LUCK !!");

    resetBoard(rod);
})();

function resetBoard(rodName) {
    //centering both rods and ball
    ...
    if (rodName === rod2Name) {
        ...
        ball.style.top = (rod2.offsetTop - rod2.offsetHeight + 10) + 'px';
        ballSpeedY = -2;
    }
